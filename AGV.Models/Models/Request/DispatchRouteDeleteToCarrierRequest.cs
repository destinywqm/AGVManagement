...
{
    public class DispatchRouteDeleteToCarrierRequest : BaseMessage
    {
        /// <summary>
        /// 小车系统编号
        /// </summary>
        ...
        public DispatchRouteDeleteToCarrierRequest(int number)
        { 
            MessageType = MessageTypeEnum.Request;
            Topic = string.Format("{0}/N{1:0000}", MyTopic.DispatchToCarrierSessionTopic, number);
            MessClass = MessClassEnum.DispatchDeleteRouteToCarrierRequest;
        }
    }
}
