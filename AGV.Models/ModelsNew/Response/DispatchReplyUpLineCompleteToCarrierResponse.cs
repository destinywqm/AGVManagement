...
namespace AGV.Models.Models.Response
{
    ...
    /// 小车响应任务
    /// </summary>
    public class DispatchReplyUpLineCompleteToCarrierResponse : BaseMessage
    {
        /// <summary>
        /// 小车系统编号
        /// </summary>
        ...
        /// 响应构造函数
        /// </summary>
        public DispatchReplyUpLineCompleteToCarrierResponse(int number)
        {
            MessageType = MessageTypeEnum.Response;
            Topic = string.Format("{0}/N{1:0000}", MyTopic.DispatchToCarrierSessionTopic, number);
            MessClass = MessClassEnum.DispatchReplyUpLineCompleteToCarrierResponse;
        }
    }
}
