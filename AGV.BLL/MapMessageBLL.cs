   ...
   public class MapMessageBLL
    {
        ...
        public bool DelRouteMapWithName(long MapTime, string MapName)
        {
            return MapMessage.DelRouteWithName(MapTime, MapName);
        }


        public bool DelMapAndRelatedTablesMap(long MapTime)
        {
            return MapMessage.DelMapAndRelatedTables(MapTime);
        }
        ...
        //删除地图
        public bool DeleteAGVMapBLL(List<string> sql)
        {
            return MapMessage.DeleteAgvMap  (sql);
        }
    }
}
